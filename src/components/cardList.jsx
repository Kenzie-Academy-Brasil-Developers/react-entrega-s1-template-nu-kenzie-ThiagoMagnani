  ...
  return (
    <div className={styleListCard.divCards}>
      ...
      <ul className={styleListCard.listCard}>
        {cards.map((card) => (
          <li className={`${styleCard.cards} ${card.type === "Entrada" ? styleCard.greenBorder : styleCard.grayBorder}`} key={card.id}>
            <div>
            ...
            <div className={styleCard.valueButton}>
              ...
              <button className={styleCard.buttonRemove} onClick={() => handleDeleteCard(card.id)}>Excluir</button>
            </div>
          </li>
        ))}
      </ul>
